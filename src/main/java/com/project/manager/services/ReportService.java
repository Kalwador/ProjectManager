...
/**
 * Service where is implemented all login necessary to generate report in pdf and sent them to email or just save in
 * given localization
 */
@Service
public class ReportService {
    ...
    public ReportService(MailFactory mailFactory, ProjectRepository projectRepository) {
        ...
        this.logger = Logger.getLogger(ReportService.class);
    }
     ...
     * Then if some parameters have right value method sent report to provided email, or to actual logged user or
     ...
     * @param email this value is email of user which will get email message with report is value isn't empty
     * @param path this is path where application will save report pdf
     */
    public void generateReport(boolean sendToMe, String email, String path) {
        String fileToDelete = "";
        try {
    ...
    /**
     * Method to send mails object to set email in parameter
     * @param email address where application will send mail with report
     * @param mail object with report attachment
     */
    private void sentMailWithReport(String email, ProjectReportMail mail) {
     ...
     * @param email value to send report file to provided user email, it will happen when email is not empty
